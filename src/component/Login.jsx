...
const Login=()=>{
    ...
    const handleLogin = () => {
        if (
          ...
          // ระยะเวลาที่ SweetAlert2 จะรอ 3 วินาที (3000 มิลลิวินาที)
          setTimeout(() => {
    ...
    return(
        <Box bg="#F2D4BC" display="grid" placeItems="center" minHeight="100vh">
            <Box bg="white" color="white" w="400px" h="500px" borderRadius="15px" boxShadow="0px 4px 6px rgba(0, 1, 1, 0.4)">
                <Box h="140px"><Image src={logocathouse} alt="Image 1" position="relative" right="-130px" bottom="-50px" /></Box>
                <Box h="70px">
                    <Text color="black" position="relative" right="-140px" fontWeight="bold" bottom="-30px"> {" "}ADMIN LOGIN{" "} </Text>
                    <Text color="black" position="relative" right="-160px" bottom="-30px"> {" "}CatHouse{" "} </Text>
                </Box>
                <Box h="110px">
                    <Flex position="relative" bottom="-35px" >
                        <Image src={emailicon} alt="Image 2" position="relative" right="-30px" bottom="-10px" w="20px" h="20px" />
                        <Input
                    ...
                    <Flex position="relative" bottom="-35px" >
                        <Image src={key} alt="Image 3" position="relative" right="-30px" bottom="-20px" w="20px" h="20px" />
                        <Input
